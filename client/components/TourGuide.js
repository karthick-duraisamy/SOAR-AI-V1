...
import { X, ChevronLeft, ChevronRight, SkipForward, CheckCircle, Star } from 'lucide-react';
export function TourGuide({ isOpen, onClose, onComplete, steps = [], tourTitle = "SOAR-AI Tour Guide" }) {
    ...
    const findElementByText = (selector, textContent) => {
        try {
    ...
    return (_jsxs("div", { className: "fixed inset-0 z-[9999]", children: [_jsx("div", { className: "absolute inset-0", children: _jsxs("svg", { width: "100%", height: "100%", className: "absolute inset-0", style: { pointerEvents: 'none' }, children: [_jsx("defs", { children: _jsxs("mask", { id: "spotlight-mask", children: [_jsx("rect", { width: "100%", height: "100%", fill: "white" }), targetElement && (_jsx("rect", { x: getSpotlightStyle().left, y: getSpotlightStyle().top, width: getSpotlightStyle().width, height: getSpotlightStyle().height, rx: "16", ry: "16", fill: "black" }))] }) }), _jsx("rect", { width: "100%", height: "100%", fill: "rgba(0, 0, 0, 0.75)", mask: "url(#spotlight-mask)" })] }) }), targetElement && (_jsxs(_Fragment, { children: [_jsx("div", { className: "absolute pointer-events-none rounded-xl", style: {
                            ...getHighlightStyle(),
                            boxShadow: '0 0 0 3px rgba(253, 150, 70, 0.4), 0 0 30px rgba(253, 150, 70, 0.3)',
                            border: 'none',
                            background: 'transparent',
                        } }), _jsx("div", { className: "absolute pointer-events-none border-3 border-[#FD9646] rounded-xl bg-transparent", style: {
                            ...getHighlightStyle(),
                            animation: 'pulse 2s infinite',
                        } }), _jsxs("div", { className: "absolute pointer-events-none", style: {
                            top: getHighlightStyle().top - 8,
                            left: getHighlightStyle().left - 8,
                        }, children: [_jsx("div", { className: "w-4 h-4 bg-[#FD9646] rounded-full shadow-lg animate-ping opacity-75" }), _jsx("div", { className: "absolute top-0 left-0 w-4 h-4 bg-[#FD9646] rounded-full shadow-lg" })] }), _jsxs("div", { className: "absolute pointer-events-none", style: {
                            top: getHighlightStyle().top - 8,
                            left: getHighlightStyle().left + getHighlightStyle().width - 8,
                        }, children: [_jsx("div", { className: "w-4 h-4 bg-[#FD9646] rounded-full shadow-lg animate-ping opacity-75" }), _jsx("div", { className: "absolute top-0 left-0 w-4 h-4 bg-[#FD9646] rounded-full shadow-lg" })] })] })), _jsx("div", { ref: tooltipRef, className: "absolute z-10 animate-in fade-in-0 zoom-in-95 duration-500", style: {
                    top: tooltipPosition.top,
                    left: tooltipPosition.left,
                }, children: _jsxs(Card, { className: "w-80 md:w-[420px] shadow-2xl border-2 border-gray-100 bg-white", children: [_jsxs(CardHeader, { className: "pb-4 relative", children: [_jsx(Button, { variant: "ghost", size: "sm", onClick: handleSkip, className: "absolute top-2 right-2 h-8 w-8 p-0 hover:bg-gray-100 rounded-full", children: _jsx(X, { className: "h-4 w-4" }) }), _jsxs("div", { className: "space-y-4 pr-8", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Star, { className: "h-5 w-5 text-[#FD9646]" }), _jsx("span", { className: "font-semibold text-gray-600 text-sm", children: tourTitle })] }), _jsxs(Badge, { variant: "outline", className: getCategoryBadgeColor(), children: ["Step ", safeCurrentStep + 1, " of ", steps.length] })] }), _jsxs("div", { className: "space-y-2", children: [_jsxs("div", { className: "flex justify-between items-center", children: [_jsx("span", { className: "text-xs font-medium text-gray-500", children: "Progress" }), _jsxs("span", { className: "text-xs font-medium text-[#FD9646]", children: [Math.round(progress), "%"] })] }), _jsx("div", { className: "relative", children: _jsx(Progress, { value: progress, className: "h-3 bg-gray-100 rounded-full overflow-hidden", children: _jsx("div", { className: "h-full bg-gradient-to-r from-[#FD9646] via-[#FD9646] to-[#FD9646]/80 rounded-full transition-all duration-500 ease-out relative overflow-hidden", style: { width: `${progress}%` }, children: _jsx("div", { className: "absolute inset-0 bg-white/20 animate-pulse" }) }) }) })] }), _jsxs(CardTitle, { className: "flex items-center gap-3 text-lg pr-4", children: [_jsx("div", { className: `w-10 h-10 rounded-xl ${getCategoryColor()} flex items-center justify-center shadow-lg`, children: _jsx("span", { className: "text-white font-bold text-sm", children: safeCurrentStep + 1 }) }), _jsxs("div", { className: "flex-1", children: [_jsx("div", { className: "text-gray-900 font-semibold leading-tight", children: currentStepData.title }), currentStepData.category && (_jsxs("div", { className: "text-xs text-gray-500 capitalize mt-1", children: [currentStepData.category, " Guide"] }))] })] })] })] }), _jsxs(CardContent, { className: "space-y-6", children: [_jsxs("div", { className: "space-y-3", children: [_jsx(CardDescription, { className: "text-gray-700 leading-relaxed text-base", children: currentStepData.description }), currentStepData.category && (_jsxs("div", { className: "text-sm text-gray-600 bg-gray-50 rounded-lg p-3 border-l-4 border-[#FD9646]", children: [_jsx("strong", { children: "\uD83D\uDCA1 Tip:" }), " ", currentStepData.category === 'navigation' ? 'Use this area to move between different sections of SOAR-AI.' :
                                                    currentStepData.category === 'action' ? 'Click here to perform important actions and operations.' :
                                                        currentStepData.category === 'content' ? 'This area displays key information and data for your review.' :
                                                            currentStepData.category === 'feature' ? 'This is a powerful feature that can help streamline your workflow.' :
                                                                'This element is an important part of the SOAR-AI interface.'] }))] }), _jsxs("div", { className: "flex items-center justify-between gap-3 pt-2", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsxs(Button, { variant: "outline", onClick: handlePrevious, disabled: safeCurrentStep === 0, className: "flex items-center gap-2 hover:border-[#FD9646] hover:text-[#FD9646] transition-all", children: [_jsx(ChevronLeft, { className: "h-4 w-4" }), "Previous"] }), _jsxs(Button, { variant: "ghost", onClick: handleSkip, className: "text-gray-500 hover:text-gray-700 hover:bg-gray-100", children: [_jsx(SkipForward, { className: "h-4 w-4 mr-2" }), "Skip Tour"] })] }), _jsx(Button, { onClick: handleNext, className: "bg-[#FD9646] hover:bg-[#FD9646]/90 text-white flex items-center gap-2 shadow-lg hover:shadow-xl transition-all duration-200", children: safeCurrentStep === steps.length - 1 ? (_jsxs(_Fragment, { children: [_jsx(CheckCircle, { className: "h-4 w-4" }), "Complete Tour"] })) : (_jsxs(_Fragment, { children: ["Next Step", _jsx(ChevronRight, { className: "h-4 w-4" })] })) })] })] })] }) }), _jsx("style", { jsx: "true", children: `
        @keyframes pulse {
          0%, 100% {
            opacity: 1;
            transform: scale(1);
...
export const aiAssistantTourSteps = [
    {
        id: 'ai-welcome',
