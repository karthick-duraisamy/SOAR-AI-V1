...
function Sidebar({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }) {
    ...
    return (_jsxs("div", { className: "group peer text-sidebar-foreground hidden md:block", "data-state": state, "data-collapsible": state === "collapsed" ? collapsible : "", "data-variant": variant, "data-side": side, "data-slot": "sidebar", children: [_jsx("div", { "data-slot": "sidebar-gap", className: cn("relative w-(--sidebar-width) bg-transparent transition-[width] duration-200 ease-linear", "group-data-[collapsible=offcanvas]:w-0", "group-data-[side=right]:rotate-180", variant === "floating" || variant === "inset"
                    ...
                    : "group-data-[collapsible=icon]:w-(--sidebar-width-icon)") }), _jsx("div", { "data-slot": "sidebar-container", className: cn("fixed inset-y-0 z-30 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex bg-white border-r border-gray-200", "w-[250px]", side === "left"
...
function SidebarInset({ className, ...props }) {
    return (_jsx("main", { "data-slot": "sidebar-inset", "data-sidebar": "inset", className: cn("bg-background relative flex flex-1 flex-col min-h-screen", "ml-[--sidebar-width] w-[calc(100%-var(--sidebar-width))]", "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-[calc(var(--sidebar-width)+0.5rem)] md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm", "md:peer-data-[state=collapsed]:ml-[--sidebar-width-icon] md:peer-data-[state=collapsed]:w-[calc(100%-var(--sidebar-width-icon))]", "max-md:ml-0 max-md:w-full", className), ...props }));
}
