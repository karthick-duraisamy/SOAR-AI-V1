...
urlpatterns = [
    ...
    path('opportunities/<int:opportunity_id>/proposal-draft/attachment/', views.download_proposal_attachment, name='download-proposal-attachment'),
    path('opportunities/send-proposal-email/', views.send_proposal_email, name='send-proposal-email'),
