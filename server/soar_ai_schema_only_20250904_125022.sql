...
ALTER TABLE IF EXISTS ONLY public.api_emailtracking DROP CONSTRAINT IF EXISTS api_emailtracking_lead_id_3450f8d8_fk_api_lead_id;
ALTER TABLE IF EXISTS ONLY public.api_emailtracking DROP CONSTRAINT IF EXISTS api_emailtracking_campaign_id_0190d8e6_fk_api_emailcampaign_id;
...
DROP INDEX IF EXISTS public.idx_lead_updated_at;
DROP INDEX IF EXISTS public.idx_lead_status;
DROP INDEX IF EXISTS public.idx_lead_score;
DROP INDEX IF EXISTS public.idx_contact_name;
DROP INDEX IF EXISTS public.idx_company_name;
DROP INDEX IF EXISTS public.idx_company_industry;
...
DROP INDEX IF EXISTS public.api_emailtracking_lead_id_3450f8d8;
DROP INDEX IF EXISTS public.api_emailtracking_campaign_id_0190d8e6;
...
ALTER TABLE IF EXISTS ONLY public.api_emailtracking DROP CONSTRAINT IF EXISTS api_emailtracking_tracking_id_key;
ALTER TABLE IF EXISTS ONLY public.api_emailtracking DROP CONSTRAINT IF EXISTS api_emailtracking_pkey;
ALTER TABLE IF EXISTS ONLY public.api_emailtracking DROP CONSTRAINT IF EXISTS api_emailtracking_campaign_id_lead_id_ffdecd59_uniq;
...
ALTER TABLE IF EXISTS ONLY public.api_airportcode DROP CONSTRAINT IF EXISTS api_airportcode_pkey;
...
DROP TABLE IF EXISTS public.api_emailtracking;
...
DROP TABLE IF EXISTS public.api_airportcode;
...
--
-- Name: api_airportcode; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.api_airportcode (
...
CREATE TABLE public.api_contract (
    ...
    client_department character varying(100) NOT NULL,
    company_email character varying(254) NOT NULL,
    custom_clauses text NOT NULL,
    exclusivity boolean NOT NULL,
    payment_terms_days integer NOT NULL,
    performance_bonus boolean NOT NULL,
...
--
-- Name: api_emailtracking; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.api_emailtracking (
    id bigint NOT NULL,
    tracking_id uuid NOT NULL,
    email_sent timestamp with time zone NOT NULL,
    first_opened timestamp with time zone,
    last_opened timestamp with time zone,
    open_count integer NOT NULL,
    first_clicked timestamp with time zone,
...
--
-- Name: api_emailtracking_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.api_emailtracking ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.api_emailtracking_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: api_airportcode api_airportcode_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.api_airportcode
    ADD CONSTRAINT api_airportcode_pkey PRIMARY KEY (code);
...
--
-- Name: api_emailtracking api_emailtracking_campaign_id_lead_id_ffdecd59_uniq; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.api_emailtracking
    ADD CONSTRAINT api_emailtracking_campaign_id_lead_id_ffdecd59_uniq UNIQUE (campaign_id, lead_id);


--
-- Name: api_emailtracking api_emailtracking_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.api_emailtracking
    ADD CONSTRAINT api_emailtracking_pkey PRIMARY KEY (id);


--
-- Name: api_emailtracking api_emailtracking_tracking_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.api_emailtracking
    ADD CONSTRAINT api_emailtracking_tracking_id_key UNIQUE (tracking_id);
...
--
-- Name: api_emailtracking_campaign_id_0190d8e6; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX api_emailtracking_campaign_id_0190d8e6 ON public.api_emailtracking USING btree (campaign_id);


--
-- Name: api_emailtracking_lead_id_3450f8d8; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX api_emailtracking_lead_id_3450f8d8 ON public.api_emailtracking USING btree (lead_id);
...
--
-- Name: idx_company_industry; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_company_industry ON public.api_company USING btree (industry);
...
CREATE INDEX idx_company_name ON public.api_company USING btree (name);
...
CREATE INDEX idx_contact_name ON public.api_contact USING btree (first_name, last_name);
...
CREATE INDEX idx_lead_score ON public.api_lead USING btree (score);
...
CREATE INDEX idx_lead_status ON public.api_lead USING btree (status);


--
-- Name: idx_lead_updated_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_lead_updated_at ON public.api_lead USING btree (updated_at DESC);
...
--
-- Name: api_emailtracking api_emailtracking_campaign_id_0190d8e6_fk_api_emailcampaign_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.api_emailtracking
    ADD CONSTRAINT api_emailtracking_campaign_id_0190d8e6_fk_api_emailcampaign_id FOREIGN KEY (campaign_id) REFERENCES public.api_emailcampaign(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: api_emailtracking api_emailtracking_lead_id_3450f8d8_fk_api_lead_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.api_emailtracking
    ADD CONSTRAINT api_emailtracking_lead_id_3450f8d8_fk_api_lead_id FOREIGN KEY (lead_id) REFERENCES public.api_lead(id) DEFERRABLE INITIALLY DEFERRED;
