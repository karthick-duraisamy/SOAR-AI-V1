...
-- Started on 2025-09-01 13:21:44 UTC
...
ALTER TABLE IF EXISTS ONLY public.api_proposaldraft DROP CONSTRAINT IF EXISTS api_proposaldraft_opportunity_id_fd7fb498_fk_api_opportunity_id;
...
ALTER TABLE IF EXISTS ONLY public.api_emailcampaign DROP CONSTRAINT IF EXISTS api_emailcampaign_template_id_3c213a84_fk_api_campa;
...
DROP INDEX IF EXISTS public.api_emailcampaign_template_id_3c213a84;
...
ALTER TABLE IF EXISTS ONLY public.api_proposaldraft DROP CONSTRAINT IF EXISTS api_proposaldraft_pkey;
ALTER TABLE IF EXISTS ONLY public.api_proposaldraft DROP CONSTRAINT IF EXISTS api_proposaldraft_opportunity_id_key;
...
ALTER TABLE IF EXISTS ONLY public.api_campaigntemplate DROP CONSTRAINT IF EXISTS api_campaigntemplate_pkey;
...
DROP TABLE IF EXISTS public.api_proposaldraft;
...
DROP TABLE IF EXISTS public.api_campaigntemplate;
...
--
-- TOC entry 269 (class 1259 OID 212993)
-- Name: api_campaigntemplate; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.api_campaigntemplate (
    id bigint NOT NULL,
    name character varying(255) NOT NULL,
    description text NOT NULL,
    channel_type character varying(20) NOT NULL,
    target_industry character varying(100) NOT NULL,
    subject_line character varying(255),
    content text NOT NULL,
    cta character varying(255) NOT NULL,
    linkedin_type character varying(20),
    estimated_open_rate double precision NOT NULL,
    estimated_click_rate double precision NOT NULL,
...
--
-- TOC entry 268 (class 1259 OID 212992)
-- Name: api_campaigntemplate_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.api_campaigntemplate ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.api_campaigntemplate_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 271 (class 1259 OID 262145)
-- Name: api_proposaldraft; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.api_proposaldraft (
    id bigint NOT NULL,
    title character varying(255) NOT NULL,
    description text NOT NULL,
    validity_period character varying(10) NOT NULL,
    special_terms text NOT NULL,
    delivery_method character varying(20) NOT NULL,
    travel_frequency character varying(20) NOT NULL,
    annual_booking_volume character varying(100) NOT NULL,
    projected_spend character varying(100) NOT NULL,
    preferred_routes text NOT NULL,
    domestic_economy integer NOT NULL,
    domestic_business integer NOT NULL,
    international integer NOT NULL,
    base_discount character varying(10) NOT NULL,
    route_discounts jsonb NOT NULL,
    loyalty_benefits jsonb NOT NULL,
    volume_incentives text NOT NULL,
    contract_duration character varying(10) NOT NULL,
    auto_renewal boolean NOT NULL,
    payment_terms character varying(20) NOT NULL,
    settlement_type character varying(20) NOT NULL,
    airline_concessions text NOT NULL,
    corporate_commitments text NOT NULL,
    internal_notes text NOT NULL,
    priority_level character varying(20) NOT NULL,
    discount_approval_required boolean NOT NULL,
    revenue_manager_assigned character varying(100) NOT NULL,
    legal_approval_required boolean NOT NULL,
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL,
    opportunity_id bigint NOT NULL,
    attachment_original_name character varying(255) NOT NULL,
    attachment_path character varying(500) NOT NULL
);


--
-- TOC entry 270 (class 1259 OID 262144)
-- Name: api_proposaldraft_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.api_proposaldraft ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.api_proposaldraft_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 3670 (class 0 OID 32884)
-- Dependencies: 261
...
--
-- TOC entry 3668 (class 0 OID 32874)
-- Dependencies: 259
...
--
-- TOC entry 3678 (class 0 OID 212993)
-- Dependencies: 269
...
--
-- TOC entry 3644 (class 0 OID 32769)
-- Dependencies: 235
...
--
-- TOC entry 3646 (class 0 OID 32777)
-- Dependencies: 237
...
--
-- TOC entry 3648 (class 0 OID 32785)
-- Dependencies: 239
...
--
-- TOC entry 3666 (class 0 OID 32859)
-- Dependencies: 257
...
--
-- TOC entry 3662 (class 0 OID 32845)
-- Dependencies: 253
...
--
-- TOC entry 3664 (class 0 OID 32853)
-- Dependencies: 255
...
--
-- TOC entry 3650 (class 0 OID 32795)
-- Dependencies: 241
...
--
-- TOC entry 3674 (class 0 OID 90134)
-- Dependencies: 265
...
--
-- TOC entry 3672 (class 0 OID 90114)
-- Dependencies: 263
...
--
-- TOC entry 3660 (class 0 OID 32835)
-- Dependencies: 251
...
--
-- TOC entry 3676 (class 0 OID 155649)
-- Dependencies: 267
...
--
-- TOC entry 3680 (class 0 OID 262145)
-- Dependencies: 271
...
--
-- TOC entry 3652 (class 0 OID 32803)
-- Dependencies: 243
...
--
-- TOC entry 3658 (class 0 OID 32825)
-- Dependencies: 249
...
--
-- TOC entry 3654 (class 0 OID 32811)
-- Dependencies: 245
...
--
-- TOC entry 3656 (class 0 OID 32819)
-- Dependencies: 247
...
--
-- TOC entry 3631 (class 0 OID 24599)
-- Dependencies: 222
...
--
-- TOC entry 3633 (class 0 OID 24607)
-- Dependencies: 224
...
--
-- TOC entry 3629 (class 0 OID 24593)
-- Dependencies: 220
...
--
-- TOC entry 3635 (class 0 OID 24613)
-- Dependencies: 226
...
--
-- TOC entry 3637 (class 0 OID 24621)
-- Dependencies: 228
...
--
-- TOC entry 3639 (class 0 OID 24627)
-- Dependencies: 230
...
--
-- TOC entry 3641 (class 0 OID 24685)
-- Dependencies: 232
...
--
-- TOC entry 3627 (class 0 OID 24585)
-- Dependencies: 218
...
--
-- TOC entry 3625 (class 0 OID 24577)
-- Dependencies: 216
...
--
-- TOC entry 3642 (class 0 OID 24713)
-- Dependencies: 233
...
--
-- TOC entry 3426 (class 2606 OID 32890)
...
--
-- TOC entry 3421 (class 2606 OID 32880)
...
--
-- TOC entry 3423 (class 2606 OID 32882)
...
--
-- TOC entry 3441 (class 2606 OID 212999)
-- Name: api_campaigntemplate api_campaigntemplate_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.api_campaigntemplate
    ADD CONSTRAINT api_campaigntemplate_pkey PRIMARY KEY (id);


--
-- TOC entry 3368 (class 2606 OID 32775)
...
--
-- TOC entry 3371 (class 2606 OID 32783)
...
--
-- TOC entry 3375 (class 2606 OID 32793)
...
--
-- TOC entry 3377 (class 2606 OID 32867)
...
--
-- TOC entry 3379 (class 2606 OID 32791)
...
--
-- TOC entry 3419 (class 2606 OID 32865)
...
--
-- TOC entry 3409 (class 2606 OID 32851)
...
--
-- TOC entry 3412 (class 2606 OID 32967)
...
--
-- TOC entry 3416 (class 2606 OID 32857)
...
--
-- TOC entry 3384 (class 2606 OID 32801)
...
--
-- TOC entry 3434 (class 2606 OID 90140)
...
--
-- TOC entry 3431 (class 2606 OID 90120)
...
--
-- TOC entry 3405 (class 2606 OID 32843)
...
--
-- TOC entry 3407 (class 2606 OID 32841)
...
--
-- TOC entry 3439 (class 2606 OID 155655)
...
--
-- TOC entry 3443 (class 2606 OID 262153)
-- Name: api_proposaldraft api_proposaldraft_opportunity_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.api_proposaldraft
    ADD CONSTRAINT api_proposaldraft_opportunity_id_key UNIQUE (opportunity_id);


--
-- TOC entry 3445 (class 2606 OID 262151)
-- Name: api_proposaldraft api_proposaldraft_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.api_proposaldraft
    ADD CONSTRAINT api_proposaldraft_pkey PRIMARY KEY (id);


--
-- TOC entry 3386 (class 2606 OID 32809)
...
--
-- TOC entry 3400 (class 2606 OID 32831)
...
--
-- TOC entry 3403 (class 2606 OID 32833)
...
--
-- TOC entry 3389 (class 2606 OID 32817)
...
--
-- TOC entry 3391 (class 2606 OID 32929)
...
--
-- TOC entry 3394 (class 2606 OID 32823)
...
--
-- TOC entry 3333 (class 2606 OID 24711)
...
--
-- TOC entry 3341 (class 2606 OID 24611)
...
--
-- TOC entry 3335 (class 2606 OID 24603)
...
--
-- TOC entry 3328 (class 2606 OID 24633)
...
--
-- TOC entry 3330 (class 2606 OID 24597)
...
--
-- TOC entry 3349 (class 2606 OID 24625)
...
--
-- TOC entry 3343 (class 2606 OID 24617)
...
--
-- TOC entry 3358 (class 2606 OID 24671)
...
--
-- TOC entry 3346 (class 2606 OID 24706)
...
--
-- TOC entry 3361 (class 2606 OID 24692)
...
--
-- TOC entry 3323 (class 2606 OID 24591)
...
--
-- TOC entry 3325 (class 2606 OID 24589)
...
--
-- TOC entry 3321 (class 2606 OID 24583)
...
--
-- TOC entry 3427 (class 1259 OID 32997)
...
--
-- TOC entry 3424 (class 1259 OID 32991)
...
--
-- TOC entry 3369 (class 1259 OID 32896)
...
--
-- TOC entry 3372 (class 1259 OID 32903)
...
--
-- TOC entry 3373 (class 1259 OID 32902)
...
--
-- TOC entry 3417 (class 1259 OID 32985)
...
--
-- TOC entry 3413 (class 1259 OID 32978)
...
--
-- TOC entry 3414 (class 1259 OID 32979)
...
--
-- TOC entry 3410 (class 1259 OID 213005)
-- Name: api_emailcampaign_template_id_3c213a84; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX api_emailcampaign_template_id_3c213a84 ON public.api_emailcampaign USING btree (template_id);


--
-- TOC entry 3380 (class 1259 OID 32919)
...
--
-- TOC entry 3381 (class 1259 OID 32920)
...
--
-- TOC entry 3382 (class 1259 OID 32921)
...
--
-- TOC entry 3432 (class 1259 OID 90151)
...
--
-- TOC entry 3435 (class 1259 OID 90152)
...
--
-- TOC entry 3428 (class 1259 OID 90131)
...
--
-- TOC entry 3429 (class 1259 OID 90132)
...
--
-- TOC entry 3436 (class 1259 OID 155666)
...
--
-- TOC entry 3437 (class 1259 OID 155667)
...
--
-- TOC entry 3396 (class 1259 OID 32958)
...
--
-- TOC entry 3397 (class 1259 OID 32959)
...
--
-- TOC entry 3398 (class 1259 OID 32960)
...
--
-- TOC entry 3401 (class 1259 OID 32957)
...
--
-- TOC entry 3392 (class 1259 OID 32941)
...
--
-- TOC entry 3395 (class 1259 OID 32940)
...
--
-- TOC entry 3331 (class 1259 OID 24712)
...
--
-- TOC entry 3336 (class 1259 OID 24653)
...
--
-- TOC entry 3339 (class 1259 OID 24654)
...
--
-- TOC entry 3326 (class 1259 OID 24639)
...
--
-- TOC entry 3347 (class 1259 OID 24669)
...
--
-- TOC entry 3350 (class 1259 OID 24668)
...
--
-- TOC entry 3353 (class 1259 OID 24683)
...
--
-- TOC entry 3356 (class 1259 OID 24682)
...
--
-- TOC entry 3344 (class 1259 OID 24707)
...
--
-- TOC entry 3359 (class 1259 OID 24703)
...
--
-- TOC entry 3362 (class 1259 OID 24704)
...
--
-- TOC entry 3363 (class 1259 OID 24721)
...
--
-- TOC entry 3366 (class 1259 OID 24720)
...
--
-- TOC entry 3473 (class 2606 OID 32992)
...
--
-- TOC entry 3472 (class 2606 OID 32986)
...
--
-- TOC entry 3455 (class 2606 OID 32891)
...
--
-- TOC entry 3456 (class 2606 OID 32897)
...
--
-- TOC entry 3457 (class 2606 OID 32868)
...
--
-- TOC entry 3471 (class 2606 OID 32980)
...
--
-- TOC entry 3469 (class 2606 OID 32968)
...
--
-- TOC entry 3470 (class 2606 OID 32973)
...
--
-- TOC entry 3468 (class 2606 OID 213000)
-- Name: api_emailcampaign api_emailcampaign_template_id_3c213a84_fk_api_campa; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.api_emailcampaign
    ADD CONSTRAINT api_emailcampaign_template_id_3c213a84_fk_api_campa FOREIGN KEY (template_id) REFERENCES public.api_campaigntemplate(id) DEFERRABLE INITIALLY DEFERRED;


--
-- TOC entry 3458 (class 2606 OID 32904)
...
--
-- TOC entry 3459 (class 2606 OID 32909)
...
--
-- TOC entry 3460 (class 2606 OID 32914)
...
--
-- TOC entry 3476 (class 2606 OID 90141)
...
--
-- TOC entry 3477 (class 2606 OID 90146)
...
--
-- TOC entry 3474 (class 2606 OID 90121)
...
--
-- TOC entry 3475 (class 2606 OID 90126)
...
--
-- TOC entry 3467 (class 2606 OID 32961)
...
--
-- TOC entry 3478 (class 2606 OID 155661)
...
--
-- TOC entry 3479 (class 2606 OID 155656)
...
--
-- TOC entry 3480 (class 2606 OID 262154)
-- Name: api_proposaldraft api_proposaldraft_opportunity_id_fd7fb498_fk_api_opportunity_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.api_proposaldraft
    ADD CONSTRAINT api_proposaldraft_opportunity_id_fd7fb498_fk_api_opportunity_id FOREIGN KEY (opportunity_id) REFERENCES public.api_opportunity(id) DEFERRABLE INITIALLY DEFERRED;


--
-- TOC entry 3464 (class 2606 OID 32942)
...
--
-- TOC entry 3465 (class 2606 OID 32947)
...
--
-- TOC entry 3466 (class 2606 OID 32952)
...
--
-- TOC entry 3461 (class 2606 OID 32922)
...
--
-- TOC entry 3462 (class 2606 OID 32935)
...
--
-- TOC entry 3463 (class 2606 OID 32930)
...
--
-- TOC entry 3447 (class 2606 OID 24648)
...
--
-- TOC entry 3448 (class 2606 OID 24643)
...
--
-- TOC entry 3446 (class 2606 OID 24634)
...
--
-- TOC entry 3449 (class 2606 OID 24663)
...
--
-- TOC entry 3450 (class 2606 OID 24658)
...
--
-- TOC entry 3451 (class 2606 OID 24677)
...
--
-- TOC entry 3452 (class 2606 OID 24672)
...
--
-- TOC entry 3453 (class 2606 OID 24693)
...
--
-- TOC entry 3454 (class 2606 OID 24698)
...
-- Completed on 2025-09-01 13:22:42 UTC
